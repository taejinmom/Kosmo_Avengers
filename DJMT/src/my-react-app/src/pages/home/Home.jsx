            ...
            <ul className="item">
              <li>
                <Link to={'/productDetail'}>
                  ...
                  <div className='item-info'>
                    ...
                    <p><span className='percentage'>20%</span> 279,200원 <span>349,000원</span></p>
                  </div>
              ...
              <li>
                <Link to={'/productDetail'}>
                  ...
                  <div className='item-info'>
                    <h3>팬시 카라 코튼 셔츠</h3>
                    <p><span className='percentage'>7%</span> 352,470원 <span>379,000원</span></p>
                  </div>
              ...
              <li>
                <Link to={'/productDetail'}>
                  ...
                  <div className='item-info'>
                    <h3>Jane Cardigan</h3>
                    <p><span className='percentage'>5%</span> 436,050원 <span>459,000원</span></p>
                  </div>
