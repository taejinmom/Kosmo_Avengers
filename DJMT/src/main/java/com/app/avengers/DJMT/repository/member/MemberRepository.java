...
public interface MemberRepository {
    //public MemberResponseDto getLoginUserByLoginId(String login_id); // 사용자 id로 response용
    ...
    public MemberDto getMemberInfoByLoginId(String login_id); // 사용자 id로 member 호출
